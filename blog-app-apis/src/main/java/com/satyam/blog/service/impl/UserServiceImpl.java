...
import com.satyam.blog.repositories.*;
import com.satyam.blog.entites.*;
import com.satyam.blog.exceptions.*;
...
public class UserServiceImpl implements UserService {
	...
	public UserDto updateUser(UserDto userDto, Integer userId) {
		User user = this.userRepo.findById(userId)
				.orElseThrow(() -> new ResourceNotFoundException("User", " dd ", userId));
